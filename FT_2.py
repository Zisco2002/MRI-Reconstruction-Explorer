...
class FFTDemo(QMainWindow):
    ...
    def _build_ui(self):
        ...
        # Larger canvases so images render bigger
        self.canvas_img = SimpleCanvas(self, width=6, height=6)
        self.canvas_k = SimpleCanvas(self, width=6, height=6)
        self.canvas_recon = SimpleCanvas(self, width=6, height=6)
